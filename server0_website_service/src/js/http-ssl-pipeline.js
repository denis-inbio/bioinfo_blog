...
const { UrlTraffic, VALIDATE_REPAIR_HttpSslUrlTraffic, VALIDATE_REPAIR_HttpUrlTraffic} = require("../model/url-traffic");
...
const PIPELINE_CheckAndSendHtml = (directoryName, htmlName, res) => {
    const path = pathlib.join(state["AbsolutePath_SecureHtmlDirectory"], directoryName, htmlName);
...
const GET_RootEN_Register = (req, res, next) => {
    const htmlName = "EN_register.html"
    const directoryName = "register";

    PIPELINE_CheckAndSendHtml(directoryName, htmlName, res);
};

const GET_RootEN_Authenticate = (req, res, next) => {
    const htmlName = "EN_authenticate.html"
    const directoryName = "authenticate";

    PIPELINE_CheckAndSendHtml(directoryName, htmlName, res);
};

const GET_RootEN_ExposableCredential = (req, res, next) => {
    const htmlName = "EN_exposable_credential.html"
    const directoryName = "exposable-credential";

    PIPELINE_CheckAndSendHtml(directoryName, htmlName, res);
};

const GET_RootEN_Session = (req, res, next) => {
    const htmlName = "EN_session.html"
    const directoryName = "session";

    PIPELINE_CheckAndSendHtml(directoryName, htmlName, res);
};

const GET_RootEN_PrivateSpace = (req, res, next) => {
    const htmlName = "EN_private_space.html"
    const directoryName = "private-space";
...
const GET_MobileRootEN_Register = (req, res, next) => {
    const htmlName = "mobile_EN_register.html"
    const directoryName = "register";
...
const GET_MobileRootEN_Authenticate = (req, res, next) => {
    const htmlName = "mobile_EN_authenticate.html"
    const directoryName = "authenticate";
...
const GET_MobileRootEN_ExposableCredential = (req, res, next) => {
    const htmlName = "mobile_EN_exposable_credential.html"
    const directoryName = "exposable-credential";
...
const GET_MobileRootEN_Session = (req, res, next) => {
    const htmlName = "mobile_EN_session.html"
    const directoryName = "session";
...
const GET_MobileRootEN_PrivateSpace = (req, res, next) => {
    const htmlName = "mobile_EN_private_space.html"
    const directoryName = "private-space";
...
const GET_RootDK_Registrere = (req, res, next) => {
    const htmlName = "DK_register.html";
    const directoryName = "register";
...
const GET_RootDK_Autentificere = (req, res, next) => {
    const htmlName = "DK_autentificere.html";
    const directoryName = "authenticate";
...
const GET_RootDK_EksponerbarLegitimation = (req, res, next) => {
    const htmlName = "DK_eksponerbar_legitimation.html";
    const directoryName = "exposable-credential";
...
const GET_RootDK_Session = (req, res, next) => {
    const htmlName = "DK_session.html";
    const directoryName = "session";
...
const GET_RootDK_PrivatRum = (req, res, next) => {
    const htmlName = "DK_privat_rum.html";
    const directoryName = "private-space";
...
const GET_MobileRootDK_Registrere = (req, res, next) => {
    const htmlName = "mobile_DK_register.html";
    const directoryName = "register";
...
const GET_MobileRootDK_Autentificere = (req, res, next) => {
    const htmlName = "mobile_DK_autentificere.html";
    const directoryName = "authenticate";
...
const GET_MobileRootDK_EksponerbarLegitimation = (req, res, next) => {
    const htmlName = "mobile_DK_eksponerbar_legitimation.html";
    const directoryName = "exposable-credential";
...
const GET_MobileRootDK_Session = (req, res, next) => {
    const htmlName = "mobile_DK_session.html";
    const directoryName = "session";
...
const GET_MobileRootDK_PrivatRum = (req, res, next) => {
    const htmlName = "mobile_DK_privat_rum.html";
    const directoryName = "private-space";
...
const GET_RootRO_Înregistrare = (req, res, next) => {
    const htmlName = "RO_înregistrează.html"
    const directoryName = "register";
...
const GET_RootRO_Autentificare = (req, res, next) => {
    const htmlName = "RO_autentifică.html"
    const directoryName = "authenticate";
...
const GET_RootRO_CredențialExpusabil = (req, res, next) => {
    const htmlName = "RO_credential_expusabil.html"
    const directoryName = "exposable-credential";
...
const GET_RootRO_Sesiune = (req, res, next) => {
    const htmlName = "RO_sesiune.html"
    const directoryName = "session";
...
const GET_RootRO_SpațiuPrivat = (req, res, next) => {
    const htmlName = "RO_spațiu_privat.html"
    const directoryName = "private-space";
...
const GET_MobileRootRO_Înregistrare = (req, res, next) => {
    const htmlName = "mobile_RO_înregistrează.html"
    const directoryName = "register";
...
const GET_MobileRootRO_Autentificare = (req, res, next) => {
    const htmlName = "mobile_RO_autentifică.html"
    const directoryName = "authenticate";
...
const GET_MobileRootRO_CredențialExpusabil = (req, res, next) => {
    const htmlName = "mobile_RO_credențial-expusabil.html"
    const directoryName = "exposable-credential";
...
const GET_MobileRootRO_Sesiune = (req, res, next) => {
    const htmlName = "mobile_RO_sesiune.html"
    const directoryName = "session";
...
const GET_MobileRootRO_SpațiuPrivat = (req, res, next) => {
    const htmlName = "mobile_RO_spațiu_privat.html"
    const directoryName = "private-space";
