...
const pipeline = require("./http-pipeline");
...
const GET = [
    ...
    // Protocol [Http -> HttpSsl]

    { route: "/protocol-redirect", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_ProtocolRedirect ]},
    ...
    { route: "/mobile", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_MobileRoot ]},
        ...
        { route: "/ro/înregistrare", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_RootRO_Înregistrare ]}, // the server emits the ownership credential, "birth / being born"; define the "pseudo-identity"
        { route: "/ro/autentificare", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_RootRO_Autentificare ]}, //
        { route: "/ro/credențial-expusabil", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_RootRO_CredențialExpusabil ]},    // choose the access rights for / configure the "indirect, exposable, cancelable, leakable credential" <re-term> (!)
        { route: "/ro/sesiune", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_RootRO_Sesiune ]},  // choose the details for the session to-be
        { route: "/ro/spațiu-privat", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_RootRO_SpațiuPrivat ]},  // see: expirables, current session(s) { route: if multiple devices ]}, traffic, connected devices, device history, control multi-user/multi-device "authorization of authentication", functions: [ CRUD expirables, CRUD "tokens" (signed, decentralized, emitted accesses), ...

        { route: "/mobile/ro", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_MobileRootRO ]},  // the navigation hub for English { route: actually, it should be USA/UK, by country, because internationalization is not just language, but instead it is nationality and culture, and even in the same nationality there can be multiple "cultural identities" which internationalization has to match]
        { route: "/mobile/ro/înregistrare", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_MobileRootRO_Înregistrare ]}, // the server emits the ownership credential, "birth / being born"; define the "pseudo-identity"
        { route: "/mobile/ro/autentificare", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_MobileRootRO_Autentificare ]}, //
        { route: "/mobile/ro/credențial-expusabil", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_MobileRootRO_CredențialExpusabil ]},    // choose the access rights for / configure the "indirect, exposable, cancelable, leakable credential" <re-term> (!)
        { route: "/mobile/ro/sesiune", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_MobileRootRO_Sesiune ]},  // choose the details for the session to-be
        { route: "/mobile/ro/spațiu-privat", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.GET_MobileRootRO_SpațiuPrivat ]},  // see: expirables, current session(s) { route: if multiple devices ]}, traffic, connected devices, device history, control multi-user/multi-device "authorization of authentication", functions: [ CRUD expirables, CRUD "tokens" (signed, decentralized, emitted accesses), ...
...
const DELETE = [
    // { route: "/api/register", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.DELETE_Root_API_Register ]},
    // { route: "/api/exposable-credential", functions: [ pipeline.SERVERSIDE_MonitorClientIPTraffic, pipeline.SERVERSIDE_MonitorURLTraffic, pipeline.DELETE_Root_API_ExposableCredential ]},
];
